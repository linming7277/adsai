...
const DEFAULT_CONFIG: EdgeCacheConfig = {
  ...
  enableStats: true,
  edgeNodes: [
    { region: 'us-east-1', endpoint: 'https://cache.us-east-1.example.com', priority: 1 },
    { region: 'us-west-2', endpoint: 'https://cache.us-west-2.example.com', priority: 2 },
    { region: 'eu-west-1', endpoint: 'https://cache.eu-west-1.example.com', priority: 2 },
    { region: 'ap-southeast-1', endpoint: 'https://cache.ap-southeast-1.example.com', priority: 3 },
  ],
  geoBasedCache: true,
