...
- **新增环境变量**: 
  - SIMILARWEB_BASE_URL: SimilarWeb API地址，默认值 https://data.similarweb.com/api/v1/data
...
管理功能:
  ...
  - API配置
    * SimilarWeb API密钥管理
    * SimilarWeb API URL配置（环境变量：SIMILARWEB_BASE_URL，默认值：https://data.similarweb.com/api/v1/data）
    * 请求频率限制
    * 错误重试策略
```
