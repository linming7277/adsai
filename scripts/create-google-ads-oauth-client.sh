...
echo "     https://preview.example.com/api/v1/adscenter/oauth/callback"
echo "     https://www.example.com/api/v1/adscenter/oauth/callback"
echo "     https://preview.example.com/api/v1/adscenter/oauth/callback"
echo "     https://example.com/api/v1/adscenter/oauth/callback"
echo ""
echo "     (可选) 添加本地开发环境:"
