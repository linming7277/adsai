...
require (
	...
	github.com/xxrenzhe/autoads/pkg/apierrors v0.0.0-20251012115218-bdfed97caabc
	github.com/xxrenzhe/autoads/pkg/cache v0.0.0
	github.com/xxrenzhe/autoads/pkg/circuitbreaker v0.0.0-00010101000000-000000000000
	...
	github.com/xxrenzhe/autoads/pkg/ratelimitredis v0.0.0-00010101000000-000000000000
...
replace github.com/xxrenzhe/autoads/pkg/ratelimitredis => ../../pkg/ratelimitredis

replace github.com/xxrenzhe/autoads/pkg/redislock => ../../pkg/redislock
...
replace github.com/xxrenzhe/autoads/pkg/circuitbreaker => ../../pkg/circuitbreaker

replace github.com/xxrenzhe/autoads/pkg/dbadmin => ../../pkg/dbadmin
