...
### Cloud SQL 实例信息
- **实例名称**: `adsai`
- **连接名**: `your-gcp-project-id:asia-northeast1:adsai`
- **数据库**: `adsai_db`
- **内网IP**: `10.6.0.2:5432`
...
# 或使用服务账号
export GOOGLE_APPLICATION_CREDENTIALS=/path/to/adsai/secrets/gcp_codex_dev.json
```
...
cloud-sql-proxy your-gcp-project-id:asia-northeast1:adsai --port 5432
...
# 使用 psql 连接
psql "postgresql://postgres:${DB_PASSWORD}@localhost:5432/adsai_db"
...
```sql
-- 连接数据库
psql "postgresql://postgres:PASSWORD@localhost:5432/adsai_db"
...
3. 验证实例连接名:
   ```bash
   gcloud sql instances describe adsai --project=your-gcp-project-id
   ```
