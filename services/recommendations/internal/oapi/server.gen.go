...
type ServerInterface interface {
	...
	ListOpportunities(w http.ResponseWriter, r *http.Request, params ListOpportunitiesParams)
	// Create an opportunity from discovery results
	// (POST /recommend/opportunities)
	CreateOpportunity(w http.ResponseWriter, r *http.Request)
	// Get opportunity detail
	// (GET /recommend/opportunities/{id})
	GetOpportunity(w http.ResponseWriter, r *http.Request, id int64)
}
...
// List recent opportunities for current user
// (GET /recommend/opportunities)
func (_ Unimplemented) ListOpportunities(w http.ResponseWriter, r *http.Request, params ListOpportunitiesParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Create an opportunity from discovery results
// (POST /recommend/opportunities)
func (_ Unimplemented) CreateOpportunity(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get opportunity detail
// (GET /recommend/opportunities/{id})
func (_ Unimplemented) GetOpportunity(w http.ResponseWriter, r *http.Request, id int64) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// ListOpportunities operation middleware
func (siw *ServerInterfaceWrapper) ListOpportunities(w http.ResponseWriter, r *http.Request) {
	...
	// ------------- Optional query parameter "seedDomain" -------------

	err = runtime.BindQueryParameter("form", true, false, "seedDomain", r.URL.Query(), &params.SeedDomain)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "seedDomain", Err: err})
		return
	}
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ListOpportunities(w, r, params)
	}))
...
// CreateOpportunity operation middleware
func (siw *ServerInterfaceWrapper) CreateOpportunity(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateOpportunity(w, r)
	}))
...
// GetOpportunity operation middleware
func (siw *ServerInterfaceWrapper) GetOpportunity(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetOpportunity(w, r, id)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/recommend/opportunities", wrapper.ListOpportunities)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/recommend/opportunities", wrapper.CreateOpportunity)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/recommend/opportunities/{id}", wrapper.GetOpportunity)
	})
